export const VIA_FERRADA_EVENT = {
    id: 'via-ferrada-2026',
    title: 'Via Ferrada Solidària',
    subtitle: 'Sant Feliu de Guíxols (Cala del Molí)',
    date: '10',
    month: 'OCT',
    year: '2026',
    ...
    status: 'Obert',
    price: 'Preu voluntari (Taquilla inversa)',
    description: 'Jornada d\'escalada i via ferrada solidària sobre el mar a la Cala del Molí per recaptar fons per a la cura dels boscos. Apte per a tots els nivells.',
...
export const VISITA_INCENDI_EVENT = {
    ...
    status: 'Obert',
    price: 'Gratuït / Aportació voluntària',
...
export const BOTIFARRADA_EVENT = {
    id: 'botifarrada-2026',
    title: 'Gran Botifarrada Popular',
    subtitle: 'Dinar de germanor & Música en directe',
    date: '24',
    month: 'OCT',
    year: '2026',
