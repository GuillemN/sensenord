export const projects = [
        ...
        fullContent: `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 my-10 not-prose">
                ...
                <div class="bg-stone-50 p-8 rounded-lg border-l-4 border-alpine-500">
                    ...
                    <p class="text-stone-600">Gràcies a tots els participants i col·laboradors per fer-ho possible.</p>
                </div>
            </div>
    ...
    },
    {
        ...
        fullContent: `
            ...
            <div class="instagram-embed-container my-10 flex justify-center not-prose">
             ...
             <p class="mb-6">Aquesta projecte neix de la voluntat de compartir. Viatgem al Senegal amb un objectiu doble que uneix esport i educació:</p>
    ...
    },
    {
        ...
        fullContent: `
            ...
            <a href="https://www.instagram.com/reel/DSFwfGmjPqf/" target="_blank" class="block group my-10 not-prose no-underline">
                <div class="bg-stone-50 border border-stone-200 rounded-xl p-6 flex items-center gap-6 hover:bg-stone-100 transition-colors shadow-sm">
                    <div class="bg-white p-3 rounded-full shadow-sm text-pink-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                    </div>
